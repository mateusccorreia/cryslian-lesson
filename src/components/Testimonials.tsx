    ...
    <section className="py-16" style={sectionStyle}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="md:hidden relative w-full max-w-xs mx-auto">
          ...
          <button
            onClick={prevSlide}
            className="absolute top-1/2 -left-1 transform -translate-y-1/2 hover:bg-yellow-400 text-black hover:text-gray-900 p-2 rounded-full transition-all z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute top-1/2 -right-1 transform -translate-y-1/2 hover:bg-yellow-400 text-black hover:text-gray-900 p-2 rounded-full transition-all z-10"
